...
namespace BMS.Models.Device {
    public class BatteryClusterInfo {
        ...
        public int TotalVoltage { get; set; }//总压101
        [Display(Name = "总电流"), PointIndex(102)]
        public int TotalCurrent { get; set; }//总电流102
        ...
        public int RatedTotalVoltage { get; set; }//额定总压106
        [Display(Name = "额定容量"), PointIndex(107)]
        public int RatedCapacity { get; set; }//额定容量107
        [Display(Name = "剩余容量"), PointIndex(108)]
        public int RemainingCapacity { get; set; }//剩余容量108
        [Display(Name = "额定电量"), PointIndex(109)]
        public int RatedEnergy { get; set; }//额定电量109
        [Display(Name = "剩余电量"), PointIndex(110)]
        public int RemainingEnergy { get; set; }//剩余电量110
        ...
        public int MaxAllowableDischargeCurrent { get; set; }//最大允许放电电流117
        [Display(Name = "最大允许放电功率"), PointIndex(118)]
        public int MaxAllowableDischargePower { get; set; }//最大允许放电功率118
        [Display(Name = "最大允许充电电流"), PointIndex(119)]
        public int MaxAllowableChargeCurrent { get; set; }//最大允许充电电流119
        [Display(Name = "最大允许充电功率"), PointIndex(120)]
        public int MaxAllowableChargePower { get; set; }//最大允许充电功率120
        ...
        public int DailyChargeCapacity { get; set; }//日充电容量139
        [Display(Name = "日充电电量"), PointIndex(140)]
        public int DailyChargeEnergy { get; set; }//日充电电量140
        [Display(Name = "日放电容量"), PointIndex(141)]
        public int DailyDischargeCapacity { get; set; }//日放电容量141
        [Display(Name = "日放电电量"), PointIndex(142)]
        public int DailyDischargeEnergy { get; set; }//日放电电量142
        [Display(Name = "日充电时间"), PointIndex(143)]
        public int DailyChargeTime { get; set; }//日充电时间143
        [Display(Name = "日放电时间"), PointIndex(144)]
        public int DailyDischargeTime { get; set; }//日放电时间144
        [Display(Name = "累计充电容量"), PointIndex(145)]
        public int CumulativeChargeCapacity { get; set; }//累计充电容量145
        [Display(Name = "累计充电电量"), PointIndex(146)]
        public int CumulativeChargeEnergy { get; set; }//累计充电电量146
        [Display(Name = "累计放电容量"), PointIndex(147)]
        public int CumulativeDischargeCapacity { get; set; }//累计放电容量147
        [Display(Name = "累计放电电量"), PointIndex(148)]
        public int CumulativeDischargeEnergy { get; set; }//累计放电电量148
        [Display(Name = "累计充电时间"), PointIndex(149)]
        public int CumulativeChargeTime { get; set; }//累计充电时间149
